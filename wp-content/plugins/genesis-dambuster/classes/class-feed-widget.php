<?php
class Genesis_Dambuster_Feed_Widget extends WP_Widget_RSS {
	...
	static function rss_output( $instance ) {
		...
		foreach ( $rss->get_items( 0, $items ) as $item ) {
			...
			printf('<div class="diy-image-feed-widget-item"><div>%1$s</div>%2$s%3$s%4$s</div>', $title, $date, $summary, $author );
		}
