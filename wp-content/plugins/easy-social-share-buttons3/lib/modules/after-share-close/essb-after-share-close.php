...
class ESSBAfterCloseShare3 {
	...
	public function register_asc_assets() {
		...
		$this->resource_files[] = array("key" => "easy-social-share-buttons-popupasc", "file" => ESSB3_PLUGIN_URL . '/assets/css/essb-after-share-close.css', "type" => "css");
		$this->resource_files[] = array("key" => "essb-aftershare-close-script", "file" => ESSB3_PLUGIN_URL . '/assets/js/essb-after-share-close.js', "type" => "js");
	}
