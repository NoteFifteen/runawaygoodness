...
class ESSBButtonHelper {
	...
	public static function draw_buttons_start($style = array(), $position = '', $salt = '', $like_or_share = 'share', $share = array()) {
		...
		$ga_tracking_code = ESSBOptionValuesHelper::options_value($essb_options, 'activate_ga_campaign_tracking');
	...
	public static function get_share_address($network, $share = array(), $salt = '') {
		...
		if ($ga_tracking_code != '') {
			...
			if (ESSBOptionValuesHelper::options_bool_value($essb_options,'twitter_shareshort') || ESSBOptionValuesHelper::options_bool_value($essb_options,'shorturl_activate') || ESSBOptionValuesHelper::options_bool_value($essb_options,'whatsapp_shareshort')) {
		...
		switch ($network) {
			...
			case "twitter" :
				...
				$twitter_message_optimize = ESSBOptionValuesHelper::options_bool_value($essb_options, 'twitter_message_optimize');
