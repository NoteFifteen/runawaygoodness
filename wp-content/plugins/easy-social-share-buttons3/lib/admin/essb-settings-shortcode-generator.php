...
?>
		...
		<div class="essb-shortcode-container essb-shortcode-select">
			...
			<a href="<?php echo esc_url(add_query_arg ( 'code', 'easy-fans', 'admin.php?page=essb_redirect_shortcode&tab=shortcode' ));?>" class="essb-shortcode essb-shortcode-fixed">[easy-fans]<br/><span class="essb-shortcode-comment">Display fans counter</span></a>
			</div>
