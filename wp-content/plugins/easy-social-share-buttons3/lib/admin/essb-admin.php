...
<?php
	...
	public function register_menu() {
		...
		if ($menu_pos) {
			...
			if (ESSB3_ADDONS_ACTIVE) {
				add_submenu_page( 'essb_options', __('Addons', ESSB3_TEXT_DOMAIN), '<span style="color:#f39c12;">'.__('Addons', ESSB3_TEXT_DOMAIN).'</span>', $essb_access, 'essb_addons', array ($this, 'essb_settings_redirect_addons' ));
			}
		}
	}
