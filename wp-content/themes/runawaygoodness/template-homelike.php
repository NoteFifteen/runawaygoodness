...
add_action( 'genesis_meta', 'rg_home_like_meta' );
/**
 * Add widget support for homepage. If no widgets active, display the default loop.
 *
 */
function rg_home_like_meta() {

	if ( is_active_sidebar( 'home-like-1' ) || is_active_sidebar( 'home-like-2' ) || is_active_sidebar( 'home-widgets-3' ) || is_active_sidebar( 'home-widgets-4' ) || is_active_sidebar( 'home-widgets-5' ) || is_active_sidebar( 'home-widgets-6' ) ) {
...
function centric_home_featured_widget() {
	...
	genesis_widget_area( 'home-like-1', array(
...
function centric_home_widgets() {
	...
	genesis_widget_area( 'home-like-2', array(
